...
© 2026 Тоц Леонид Александрович. **Все права защищены.**

Этот репозиторий предназначен только для просмотра в образовательных целях.
Копирование, распространение, модификация или использование кода без 
письменного разрешения автора **запрещено**. Это сделано для того, чтобы соблюсти политику
образовательной площадки Stepic. *Подробнее смотри в [LICENSE](LICENSE)*
